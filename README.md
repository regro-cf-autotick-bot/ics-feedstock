...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ics-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11472&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ics-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ics` can be installed with:

```
conda install ics
```

It is possible to list all of the versions of `ics` available on your platform with:
